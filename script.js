...
(_a = document
    ...
    if (profilePic &&
        ...
        var documentOutputElement = document.getElementById("resumeOutput");
            ...
            copyLinkButton.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            shareableLink = "https://amazing-blini-7f1d40.netlify.app/".concat(name_1.replace(/\s+/g, "_"), "_cv.html ");
